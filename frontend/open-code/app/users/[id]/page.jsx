...
<svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24" viewBox="0 0 20 20" fill="currentColor">
  <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
    ...
    <div class="space-x-4 flex flex-row flex-wrap w-82 justify-center gap-6 mt-32 md:mt-0 md:justify-center">
<button
...
>
  Connect
    ...
    <button
  class="text-white py-2 px-4 ml-0 uppercase rounded bg-gray-700 hover:bg-gray-800 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"
>
  Message
</button>
    </div>
